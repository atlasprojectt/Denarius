...
export const copy = {
  ...
  liveCardCta: "Gerar agora",
  agoraFileTitle: "Relatório atual",
  agoraFileStamp: (dateTime: string, month: string) =>
    `Gerado em ${dateTime} · ${month}`,
  openFile: (title: string) => `Abrir ${title}`,
  previewUnavailable: "Não foi possível exibir o relatório.",
  retry: "Tentar novamente",
  closingTitle: "Fechamento do mês",
  closingFileTitle: (month: string) =>
    `Fechamento de ${month.charAt(0).toLocaleLowerCase("pt-BR")}${month.slice(1)}`,
  closingLockedIn: (date: string) => `Disponível em ${date}`,
  closingAvailableNow: "Disponível agora",
  closingNew: "Novo",
  closingNewHint: "Novo relatório de fechamento disponível",
  previewClose: "Fechar",
  downloadPdf: "Baixar PDF",
  preparingPdf: "Preparando PDF…",
  previewLoading: "Carregando relatório…",
  ...
  downloadUnavailable:
    "O relatório está temporariamente indisponível. Tente novamente.",
