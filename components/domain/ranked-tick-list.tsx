      ...
      {rows.map((row, index) => (
        ...
        >
          ...
          <div className="relative mt-1.5 h-2 w-full">
            <div
              aria-hidden
              className="absolute inset-0 origin-center text-bar-track group-hover/row:scale-y-[1.5] group-hover/row:text-bar-track motion-safe:transition-[color,transform] motion-safe:duration-(--motion-duration-max) motion-safe:ease-(--motion-ease-standard)"
              style={TICKS}
            />
            <div
              data-reveal-bar
